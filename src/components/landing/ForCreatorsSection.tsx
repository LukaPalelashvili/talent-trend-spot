...
const ForCreatorsSection = () => {
  return (
    <section id="for-creators" className="py-24 md:py-32 section-gradient">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <div className="aspect-square bg-gradient-to-br from-accent/5 to-primary/5 p-8">
                ...
                {/* Earnings Card */}
                <div className="absolute bottom-12 right-4 bg-white rounded-xl shadow-lg p-4 animate-float-medium">
            ...
            {/* Floating element */}
            <div className="absolute -bottom-4 -left-4 w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-400 to-primary shadow-xl flex items-center justify-center animate-float-slow">

    ...
    <section className="py-24 md:py-32 bg-white">
      <div className="container">
        ...
        <div className="rounded-3xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="bg-[#ede9fe] p-8 md:p-12 flex-1 flex flex-col justify-center">
            {/* Tabs */}
          ...
          <div className="bg-[#7c3aed] p-8 md:p-12 flex-1 relative overflow-hidden min-h-[400px] md:min-h-[500px]">
            {/* Sparkles decoration */}
            <Sparkles
              size={16}
